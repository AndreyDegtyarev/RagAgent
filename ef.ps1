...
function Run-EfCommand {
    ...
    $cmdParts = $Command -split ' ' | Where-Object { $_ }
    $argParts = $Arguments -split ' ' | Where-Object { $_ }
    dotnet ef $cmdParts $argParts --project $Project --startup-project $StartupProject
}
